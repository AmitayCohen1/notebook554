      ...
      <div className="flex-1 flex pt-14 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col gap-16 w-full items-center">
            ...
            {/* Decorative Page Peeks */}
            <div className="space-y-4 w-full max-w-4xl opacity-20 pb-20">
              <div className="w-full h-4 bg-[hsl(var(--bg-sheet))] rounded-t-lg shadow-2xl border-x border-t border-white/5" />
              <div className="w-full h-4 bg-[hsl(var(--bg-sheet))] rounded-t-lg shadow-2xl border-x border-t border-white/5 mx-auto max-w-[98%]" />
            </div>
          </div>
        </main>
